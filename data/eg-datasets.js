...
const EG_GROUPS = [
  ...
  },
  {
    ...
    quizzes:[
      ...
      {key:'english_clubs',     icon:'🏟️', desc:'Every club across the top 7 tiers of English football · 164 clubs'},
    ]
  },
  {
...
const EG_DATASETS = {
  ...
  english_clubs: {
    title: 'Every Club in English Football',
    missingLabel: 'clubs',
    // All 164 clubs across the top 7 tiers (Premier League → National League South).
    players: [
      {name:"AFC Bournemouth", aliases:["bournemouth","cherries"]},
      {name:"Arsenal", aliases:["gunners"]},
      {name:"Aston Villa", aliases:["villa"]},
      {name:"Brentford", aliases:[]},
      {name:"Brighton & Hove Albion", aliases:["brighton hove","brighton","brighton and hove albion","seagulls"]},
      {name:"Burnley", aliases:[]},
      {name:"Chelsea", aliases:["cfc"]},
      {name:"Crystal Palace", aliases:["palace","eagles"]},
      {name:"Everton", aliases:[]},
      {name:"Fulham", aliases:[]},
      {name:"Leeds United", aliases:["leeds"]},
      {name:"Liverpool", aliases:["lfc","the reds"]},
      {name:"Manchester City", aliases:["man city","mcfc"]},
      {name:"Manchester United", aliases:["man united","man utd","mufc"]},
      {name:"Newcastle United", aliases:["newcastle","toon","nufc"]},
      {name:"Nottingham Forest", aliases:["forest","nffc"]},
      {name:"Sunderland", aliases:[]},
      {name:"Tottenham Hotspur", aliases:["tottenham","spurs","thfc"]},
      {name:"West Ham United", aliases:["west ham","hammers","irons"]},
      {name:"Wolverhampton Wanderers", aliases:["wolverhampton","wolves"]},
      {name:"Birmingham City", aliases:["birmingham"]},
      {name:"Blackburn Rovers", aliases:["blackburn"]},
      {name:"Bristol City", aliases:[]},
      {name:"Charlton Athletic", aliases:["charlton","addicks"]},
      {name:"Coventry City", aliases:["coventry","sky blues"]},
      {name:"Derby County", aliases:["derby","rams"]},
      {name:"Hull City", aliases:["hull","tigers"]},
      {name:"Ipswich Town", aliases:["ipswich","tractor boys"]},
      {name:"Leicester City", aliases:["leicester","foxes"]},
      {name:"Middlesbrough", aliases:["boro"]},
      {name:"Millwall", aliases:["lions"]},
      {name:"Norwich City", aliases:["norwich","canaries"]},
      {name:"Oxford United", aliases:[]},
      {name:"Portsmouth", aliases:["pompey"]},
      {name:"Preston North End", aliases:["preston","pne"]},
      {name:"Queens Park Rangers", aliases:["qpr","hoops"]},
      {name:"Sheffield Wednesday", aliases:["sheff wed","owls"]},
      {name:"Sheffield United", aliases:["sheff utd","blades"]},
      {name:"Southampton", aliases:[]},
      {name:"Stoke City", aliases:["stoke","potters"]},
      {name:"Swansea City", aliases:["swansea","swans"]},
      {name:"Watford", aliases:["hornets"]},
      {name:"West Bromwich Albion", aliases:["west bromwich","west brom","wba","baggies"]},
      {name:"Wrexham", aliases:[]},
      {name:"AFC Wimbledon", aliases:["wimbledon"]},
      {name:"Barnsley", aliases:["tykes"]},
      {name:"Blackpool", aliases:["seasiders"]},
      {name:"Bolton Wanderers", aliases:["bolton","trotters"]},
      {name:"Bradford City", aliases:["bradford","bantams"]},
      {name:"Burton Albion", aliases:["burton"]},
      {name:"Cardiff City", aliases:["cardiff","bluebirds"]},
      {name:"Doncaster Rovers", aliases:["doncaster"]},
      {name:"Exeter City", aliases:["exeter"]},
      {name:"Huddersfield Town", aliases:["huddersfield","terriers"]},
      {name:"Leyton Orient", aliases:[]},
      {name:"Lincoln City", aliases:["lincoln"]},
      {name:"Luton Town", aliases:["luton","hatters"]},
      {name:"Mansfield Town", aliases:["mansfield"]},
      {name:"Northampton Town", aliases:["northampton"]},
      {name:"Peterborough United", aliases:["posh"]},
      {name:"Plymouth Argyle", aliases:["pilgrims"]},
      {name:"Port Vale", aliases:["vale"]},
      {name:"Reading", aliases:[]},
      {name:"Rotherham United", aliases:["rotherham"]},
      {name:"Stevenage", aliases:[]},
      {name:"Stockport County", aliases:["stockport"]},
      {name:"Wigan Athletic", aliases:["wigan","latics"]},
      {name:"Wycombe Wanderers", aliases:["wycombe"]},
      {name:"Accrington Stanley", aliases:["accrington"]},
      {name:"Barnet", aliases:[]},
      {name:"Barrow", aliases:[]},
      {name:"Bristol Rovers", aliases:[]},
      {name:"Bromley", aliases:[]},
      {name:"Cambridge United", aliases:["cambridge"]},
      {name:"Cheltenham Town", aliases:["cheltenham"]},
      {name:"Chesterfield", aliases:["spireites"]},
      {name:"Colchester United", aliases:["colchester"]},
      {name:"Crawley Town", aliases:["crawley"]},
      {name:"Crewe Alexandra", aliases:[]},
      {name:"Fleetwood Town", aliases:["fleetwood"]},
      {name:"Gillingham", aliases:["gills"]},
      {name:"Grimsby Town", aliases:["grimsby","mariners"]},
      {name:"Harrogate Town", aliases:["harrogate"]},
      {name:"Milton Keynes Dons", aliases:["mk dons","mkdons"]},
      {name:"Newport County", aliases:["newport"]},
      {name:"Notts County", aliases:["notts"]},
      {name:"Oldham Athletic", aliases:["oldham"]},
      {name:"Salford City", aliases:["salford"]},
      {name:"Shrewsbury Town", aliases:["shrewsbury","shrews"]},
      {name:"Swindon Town", aliases:["swindon","robins"]},
      {name:"Tranmere Rovers", aliases:["tranmere"]},
      {name:"Walsall", aliases:["saddlers"]},
      {name:"Aldershot Town", aliases:["aldershot"]},
      {name:"Altrincham", aliases:[]},
      {name:"Boreham Wood", aliases:[]},
      {name:"Boston United", aliases:["boston"]},
      {name:"Brackley Town", aliases:["brackley"]},
      {name:"Braintree Town", aliases:["braintree"]},
      {name:"Carlisle United", aliases:["carlisle"]},
      {name:"Eastleigh", aliases:[]},
      {name:"Forest Green Rovers", aliases:["forest green"]},
      {name:"Gateshead", aliases:[]},
      {name:"Halifax Town", aliases:["halifax","fc halifax town"]},
      {name:"Hartlepool United", aliases:["hartlepool"]},
      {name:"Morecambe", aliases:[]},
      {name:"Rochdale", aliases:[]},
      {name:"Scunthorpe United", aliases:["scunthorpe"]},
      {name:"Solihull Moors", aliases:[]},
      {name:"Southend United", aliases:["southend"]},
      {name:"Sutton United", aliases:["sutton"]},
      {name:"Tamworth", aliases:[]},
      {name:"Truro City", aliases:["truro"]},
      {name:"Wealdstone", aliases:[]},
      {name:"Woking", aliases:[]},
      {name:"Yeovil Town", aliases:["yeovil"]},
      {name:"York City", aliases:["york"]},
      {name:"AFC Fylde", aliases:["fylde"]},
      {name:"AFC Telford United", aliases:["telford united","afc telford","telford"]},
      {name:"Alfreton Town", aliases:["alfreton"]},
      {name:"Bedford Town", aliases:["bedford"]},
      {name:"Buxton", aliases:[]},
      {name:"Chester", aliases:[]},
      {name:"Chorley", aliases:[]},
      {name:"Curzon Ashton", aliases:[]},
      {name:"Darlington", aliases:[]},
      {name:"Hereford", aliases:[]},
      {name:"Kidderminster Harriers", aliases:[]},
      {name:"King's Lynn Town", aliases:["kings lynn"]},
      {name:"Leamington", aliases:[]},
      {name:"Macclesfield", aliases:[]},
      {name:"Marine", aliases:[]},
      {name:"Merthyr Town", aliases:["merthyr"]},
      {name:"Oxford City", aliases:[]},
      {name:"Peterborough Sports", aliases:[]},
      {name:"Radcliffe", aliases:[]},
      {name:"Scarborough Athletic", aliases:["scarborough"]},
      {name:"Southport", aliases:[]},
      {name:"South Shields", aliases:["shields"]},
      {name:"Spennymoor Town", aliases:["spennymoor"]},
      {name:"Worksop Town", aliases:["worksop"]},
      {name:"AFC Totton", aliases:["totton"]},
      {name:"Bath City", aliases:["bath"]},
      {name:"Chelmsford City", aliases:["chelmsford"]},
      {name:"Chesham United", aliases:["chesham"]},
      {name:"Chippenham Town", aliases:["chippenham"]},
      {name:"Dagenham & Redbridge", aliases:["dagenham","dagenham and redbridge"]},
      {name:"Dorking Wanderers", aliases:["dorking"]},
      {name:"Dover Athletic", aliases:["dover"]},
      {name:"Eastbourne Borough", aliases:["eastbourne"]},
      {name:"Ebbsfleet United", aliases:["ebbsfleet"]},
      {name:"Enfield Town", aliases:["enfield"]},
      {name:"Farnborough", aliases:[]},
      {name:"Hampton & Richmond Borough", aliases:["hampton richmond","hampton and richmond"]},
      {name:"Hemel Hempstead Town", aliases:["hemel hempstead"]},
      {name:"Hornchurch", aliases:[]},
      {name:"Horsham", aliases:[]},
      {name:"Maidenhead United", aliases:["maidenhead"]},
      {name:"Maidstone United", aliases:["maidstone"]},
      {name:"Salisbury", aliases:[]},
      {name:"Slough Town", aliases:["slough"]},
      {name:"Tonbridge Angels", aliases:[]},
      {name:"Torquay United", aliases:["torquay"]},
      {name:"Weston-super-Mare", aliases:["weston","weston super mare"]},
      {name:"Worthing", aliases:[]},
    ]
  }
};
